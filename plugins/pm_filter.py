...
async def pm_text(bot, message):
    ...
    await message.reply_text(
         text=f"<b>🎗 If You Want Any Files Use Me Inline Or Join Our Group Below 👇🏻</b>",   
         reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("🔆 Group Link", url=f"https://t.me/Rubina_Updates")]])
    )
